   ...
   const checkFn = (role: any) => {
    ...
    return (
        <div>
            ...
            {/* <section>
                <div classNameName='border-3 w-96 h-96 '>
                </div>
            </section> */}
            ...
            <div className="flex items-center justify-center">
                <form className="flex gap-20">
                    <div className='text-center' onClick={() => checkFn('freelance')}>
                        ...
                        <label className="flex h-96 w-96 cursor-pointer flex-col rounded-lg border border-gray-300 p-4 peer-checked:border-4" htmlFor="radio_1">
                    ...
                    <div className='text-center' onClick={() => checkFn('client')}>
                        ...
                        <label className="flex h-96 w-96 cursor-pointer flex-col rounded-lg border border-gray-300 p-4 peer-checked:border-4" htmlFor="radio_2">
