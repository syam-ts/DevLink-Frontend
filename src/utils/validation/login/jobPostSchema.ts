...
export const jobPostSchema = yup.object().shape({
    ...
    payment: yup.string().min(3, "100rs is the minimum").required("Payment is required"),
    ...
    maxProposals: yup.number().min(3, "Add number more than 3").max(10, "Add number less than 10").required("Max proposal is required"),
