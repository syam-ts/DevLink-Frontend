...
function ViewRoleInAdmin({ roleId, roleInfo }) {
  ...
  useEffect(() => {
    (async () => {
      const response = await axios.get(
        `http://localhost:3000/admin/viewRole/${roleId}/${roleInfo}`
      );
              ...
              <div className=" flex max-w-full flex-col items-center rounded-xl  px-4 py-4 text-center  ">
                ...
                <div className="">
                  ...
                  <div className="flex space-x-2">
                    <button className="w-full rounded-lg border-black border bg-white px-4 py-2 font-medium text-gray-500">
                      {" "}
                      Close{" "}
                    </button>
...
export default ViewRoleInAdmin;
