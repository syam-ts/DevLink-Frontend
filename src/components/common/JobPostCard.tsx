...
export const JobPostCard = ({
  ...
  return (
    <div className="px-12">
    {Object.entries(jobs).map((job: any, index: number) => (
      <div
        key={index}
      ...
      >
        <div className="flex flex-col sm:flex-row justify-between gap-6">
          ...
          <div className="grid">
            <span className="text-lg sm:text-2xl text-start">{job[1]?.title}</span>
          ...
          <div className="grid text-start sm:text-end py-3">
            ...
            <span className="text-sm sm:text-base">{job[1]?.paymentType}</span>
