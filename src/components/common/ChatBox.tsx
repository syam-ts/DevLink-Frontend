    ...
    return (
        <section>
            <div className="flex-1 sm:p-6 flex rounded-xl justify-between shadow-2xl flex-col h-[50rem] w-[70rem] mx-10 border border-gray-800">
                <div className="flex sm:items-center justify-between py-3 "></div>
                <div
                    id="messages"
                    className="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-hide scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch"
                >
                    <div className="chat-message">
                        {messages.map((message: Messages) => (
                            <div>
                                {roleType === "user" ? (
                                    <div
                                        className={`grid gap-3 ${message.roleType === "user"
                                                ? "justify-end"
                                                : "justify-start"
                                            } `}
                                    >
                                    ...
                                    <div
                                        className={`grid gap-3 ${message.roleType === "client"
                                                ? "justify-end"
                                                : "justify-start"
                                            }`}
                                    >
