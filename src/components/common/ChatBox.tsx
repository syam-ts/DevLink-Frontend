...
export const ChatBox = () => {
    ...
    return (
        ...
        <section>
            <div className="flex-1 p:2 sm:p-6 justify-between flex flex-col h-[40rem] w-[60rem] mx-auto  border border-gray-800">
                ...
                <div className="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
                    <div className="relative flex">
                        ...
                        <div className="absolute right-0 items-center inset-y-0 hidden sm:flex">
                            ...
                            <button
                                onClick={sendMessage} type="button" className="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none">
