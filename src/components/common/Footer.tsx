...
const Footer = () => {
    ...
    return (
                <footer className="bg-blueGray-200 mt-96 pt-64 pb-6 arsenal-sc-regular">
                                ...
                                <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                                    <div className="text-sm text-blueGray-500 font-semibold py-1">
                                        ...
                                        <a href="https://www.creative-tim.com/product/notus-js" className="text-blueGray-500 hover:text-gray-800" target="_blank"/> Devlink JS by
                                            <a href="https://www.creative-tim.com?ref=njs-profile" className="text-blueGray-500 hover:text-blueGray-800">Syamdev</a>.
                                    </div>
                                </div>
                            </div>
                    </div>
