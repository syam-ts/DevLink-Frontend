import {
  ...
  /// comppnayname, locatin, email, sice, totaljobs, ood emploees
  
  export const ClientProfileModal = ({ clientData }) => {
   ...
   console.log('The clietn: ', clientData)
                        ...
                        <div className="flex justify-between text-center">
                          <div className="w-full grid gap-3">
                            ...
                            <span className=" font-semibold text-md">
                              Domain: {clientData[1].domain}
                            </span>
                            <span className=" font-semibold text-md">
                              Location: {clientData[1].location}
                            </span>
                            <span className=" font-semibold text-md">
                              Since: {clientData[1].since}
                            </span>
                            <span className=" font-semibold text-md">
                              Total Jobs: {clientData[1].totalJobs}
                            </span>
                            <span className=" font-semibold text-md">
                              No. of Employees : {clientData[1].numberOfEmployees}
                            </span> 
                          </div>
