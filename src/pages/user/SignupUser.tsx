...
const SignupUser = () => {
  const [sonner, setSonner] = useState<{ message: string; timestamp: number }>({
    message: "",
    timestamp: 0,
  });
    ...
    try {
      ...
      if (response.data.type !== "success") {
        ...
        navigate("/user/verify-otp", {
          state: { message: data, color: "success" },
        });
      }
    } catch (err) {
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  type="text"
                  required
                  className="w-full   border-1 text-sm text-gray-800 border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none"
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full text-sm text-gray-800   border-1  border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none"
