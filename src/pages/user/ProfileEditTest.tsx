                                    ...
                                    <MDBCard>
                                        ...
                                        <div className="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
                                            <div className="container max-w-screen-lg mx-auto">
                                                <div>
                                                    <h2 className="font-semibold text-xl text-gray-600">Edit Profile Form</h2>
                                                    <p className="text-gray-500 mb-6">Fill the fields which you want to edit.</p>

                                                    <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                                                            <div className="text-gray-600 my-auto"> 
                                                                <img className='w-44 h-44 ' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTxNc5lx8Yi6_zm4jfsxmE7Id5GQOjJY5aopKldIHFEPffj593Svs527Xx2cRgEmjwnWzk&usqp=CAU' />
                                                                <p className='text-center text-blue-600'>Edit</p>
                                                            </div>
                                                            ...
                                                            <div className="lg:col-span-2">
                                                                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                                                    ...
                                                                    <div className="md:col-span-5">
                                                                        <label >Mobile</label>
                                                                        <input type="number" name="mobile" id="mobile" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="email@domain.com" />
                                                                    </div>
