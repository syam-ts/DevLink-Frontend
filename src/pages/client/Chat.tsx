    ...
    return (
        <div className='flex'>
                   ...
                   <div className='w-1/4 border-r '>
                         <div className='my-5 '>
                            <ul className='flex gap-20 bg-gray-200 rounded-md py-2.5'>
                                <li><img src='https://pagedone.io/asset/uploads/1710412177.png' className='w-10 h-10' /></li>
                                <li> <span className='font-mono text-lg '>Shanay cruz</span> </li>
                            </ul>
                            </div>
                   </div>
                ...
                <div className=" w-2/3 h-screen p-10">
                    ...
                    <div className="w-full pl-3 pr-1 py-1 rounded-3xl border border-gray-200 items-center gap-2 inline-flex justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <input className="grow shrink basis-0 text-black text-xs font-medium leading-4 focus:outline-none" placeholder="Type here..." />
                        </div>
                        <div className="flex items-center gap-2">
