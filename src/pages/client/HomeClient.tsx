        ...
        <main className='arsenal-sc-regular'>
                ...
                <figure className="relative transition-all duration-300 cursor-pointer  hover:grayscale-0">
                    ...
                    <figcaption className="absolute text-lg text-white bottom-6 ">
                        <div className='mb-44 ml-20'>
                            <div>
                                <span className='text-black  text-3xl'>Thrive the World of Freelance
                                    <br /> Excellence Marketplace</span>
                            </div>
                            <div>
                                <span className='text-black  text-xl'>TFlourish in a thriving freelance ecosystem dedicated to
                                ...
                                <button
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="flex items-center transition-all opacity-1 valid:"><span
                                            className="text-sm  whitespace-nowrap truncate mx-auto">
                                            Search
                                        </span>
                                        </div> 
                                    </div> 
            ...
            <section className='text-center my-12 mt-44'>
                ...
                <div className='text-end px-96'>
                    <span className=''>
                        <Link to='/client/developers/view'>
                            More Users
                        </Link>
                    </span>
                </div>
                        ...
                        <Card className="col-span-12 sm:col-span-4 h-[250px]">
                            ...
                            <Link to={`/client/userProfile/view/${user?.[1]._id}/client-view`}>
                                <img
                                    ...
                                    src={user?.[1]?.profilePicture || 'https://img.freepik.com/premium-vector/professional-grey-default-avatar-profile-icon-placeholder_1147429-12635.jpg'}
                                />
                            </Link>
                        </Card>
