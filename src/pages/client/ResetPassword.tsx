 ...
 const { clientId } = useParams();
  ...
  const handleSubmit = async () => {
    ...
    try {
     ...
     const response = await axios.post(`http://localhost:3000/client/resetPassword/${clientId}`, formData, {
        ...
        <form className="max-w-xl w-full p-6 mx-auto">
          ...
          <div>                   
            ...
            <div className="relative flex items-center">
              <input name="password" type="password" onChange={handleChange} required className="w-full border-1 text-sm text-gray-800 border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter New Password" />
