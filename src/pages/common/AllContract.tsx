                ...
                ([key, contract]: [string, Contract]) => (
                  <div className="w-full" key={key}>
                    ...
                    >
                      ...
                      {contractsViewType === "pending" && (
                        <span className="absolute py-2 sm:py-2 px-5 sm:px-5 text-xs sm:text-sm text-white top-0 right-0 bg-[#0000ff] rounded-small transform translate-x-2 -translate-y-2 sm:-translate-y-3 shadow-md">
                          New
                        </span>
                      )}
                    </div>
