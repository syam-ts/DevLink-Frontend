   ...
   useEffect(() => {
    try{
          (async() => {
            ...
            console.log('THE WALLET 2', data?.data?.wallet?.transactions)
  ...
  return (
    <div>
      ...
      <h2 className='font-bold text-xl py-5'>Transaction History</h2>
       ...
       <div className=" mx-5 mt-12 px-12  w-full h-full  text-gray-700 bg-white shadow-xl border border-gray-230 rounded-xl bg-clip-border">
                    <table className="w-full text-center table-auto">
                        <thead className='flex'>
                        <tr>
                            <th className=" py-4 border-b border-blue-gray-100 bg-blue-gray-50">
                            <p className="block antialiased font-bold text-md leading-none text-black">
                                Type
                            </p>
                            </th>
                            <th className="pl-44 py-4 border-b border-blue-gray-100 bg-blue-gray-50">
                            <p className="block antialiased font-bold text-md leading-none text-black">
                                Amount
                            </p>
                            </th>
